...
int main () {
	...
	int random_number, count_heads=0, count_tails=0; //Declaring the variables

	while(count_tails!=1000){		//Looping until 1000 heads show up
